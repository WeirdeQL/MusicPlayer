 ...
 */
public class MusicBaseInfo extends LinearLayout {
    public MusicBaseInfo(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
    ...
    private void init(Context context) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.baseinfo, this);
